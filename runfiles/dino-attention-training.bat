@echo off
echo ==============================================
echo Starting DINO Attention Steganography Training
echo ==============================================

REM Set experiment name with timestamp
set TIMESTAMP=%date:~-4,4%.%date:~-10,2%.%date:~-7,2%--%time:~0,2%-%time:~3,2%-%time:~6,2%
set TIMESTAMP=%TIMESTAMP: =0%
set EXPERIMENT_NAME=dino_attention_%TIMESTAMP%

echo Experiment Name: %EXPERIMENT_NAME%
echo Encoder Mode: dino-attention
echo.
...
echo Starting training with DINO Attention encoder...
...
REM Run training with DINO attention mode
python main.py new ^
    --data-dir "%DATA_DIR%" ^
...
echo.
echo ==============================================
echo DINO Attention Training Completed Successfully!
