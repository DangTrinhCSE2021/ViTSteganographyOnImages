...
set EXPERIMENT_NAME=dino_output_%TIMESTAMP%
...
echo Starting training with DINO ViT encoder...
...
REM Run training with DINO output mode
python main.py new ^
    --data-dir "%DATA_DIR%" ^
...
echo.
echo ==============================================
echo DINO ViT Training Completed Successfully!
